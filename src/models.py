...
class Organization:
    ...
    auditor: Chairman # Аудитор, от имени которого пишется отчет (должность, Ф.И.О. полностью)
    leader: Chairman  # Руководитель организации (должность, Ф.И.О. полностью)
    chairman: Chairman # Председатель комиссии по проведению специальной оценки условий труда (должность, Ф.И.О. полностью)
    com_members: List[Chairman] # Члены Комиссии по проведению СОУТ3 (должность, Ф.И.О. полностью)
